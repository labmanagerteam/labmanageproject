...
my_order_check_str = r'^stu_my_check'
...
urlpatterns = patterns('',
                       ...
                       url(open_lab_str + r'/open_lab_check/detail/(.*)/$', all_check(get_detail_open_lab)),
                       url(open_lab_str + r'/open_lab_check/accept/$', all_check(accept_open_lab_view)),
                       url(open_lab_str + r'/open_lab_check/refuse/$', all_check(refuse_open_lab_view)),
                       url(open_lab_str + r'/open_lab_mine/$', all_check(my_open_lab_view)),
                       url(open_lab_str + r'/open_lab_mine/detail/([^/]+)/([^/]+)/$', all_check(my_open_lab_detail_view)),
                       url(open_lab_str + r'/open_lab_new/send_open_lab/$', all_check(send_open_lab)),
                       url(new_open_lab + r'/send_open_lab/$', all_check(send_open_lab)),
                       url(open_lab_str + r'/open_lab_new/send_circle_open_lab/$', all_check(send_circle_open_lab_view)),
                       url(new_open_lab + r'/send_circle_open_lab/$', all_check(send_circle_open_lab_view)),
                       url(r'^get_lab_by_lcid/$', get_lab_by_lcid_view),
                       url(check_open_lab_str + r'/$', all_check(check_open_lab)),
                       url(open_lab_str + r'/get_uncheck_open_lab/$', all_check(get_uncheck_open_lab)),
                       ...
                       url(check_stu_app + r'/reflect/$', all_check(check_user_order_reflect_view)),
                       url(check_stu_app + r'/circle_reflect/$', all_check(check_circle_order_reflect_view)),
                       ...
                       url(my_order_check_str + '/$', all_check(my_order_view_apply)),
                       url(my_order_check_str + '/detail/([^/]+)/$', all_check(my_order_view_apply_detail)),
                       url(my_order_check_str + r'/order/$', all_check(order_view)),
                       url(my_order_check_str + r'/order_circle/', all_check(order_circle_view)),
